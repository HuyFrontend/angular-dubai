...
export class InfoComponentShowData extends InfoComponentData {
    constructor() {
      super();
    ...
    linkDataBOList: Array<ShowLinkedData>;
}


export class ShowLinkedData {
  ...
  getValue(): ShowLinkedData{
    return new ShowLinkedData(this.entityId, this.linkedItem1, this.linkedItem2);
  }
}


export class ShowLinkedDataVO {
  showLinked: ShowLinkedData;
  props: {};
